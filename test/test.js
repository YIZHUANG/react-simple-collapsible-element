...
describe("with custom transition", () => {
  test("has the correct transition prop", () => {
    const wrapper = mount(
      <Collapsible customTransition="height .1s ease-out" data={data1} />
    );
    expect(
      wrapper
        .find(CollapsePane)
...
describe("Title and Content as functions", () => {
  test("non-nested element has the correct open params pass to it", () => {
    const wrapper = mount(
      <Collapsible customTransition="height .1s ease-out" data={data2} />
    );
    wrapper
      .find(CollapsePane)
      .find(Title)
    ...
    expect(
      wrapper
        ...
        .at(0)
        .text()
    ).toBe("This title is current open");
    wrapper
      .find(CollapsePane)
      .find(Title)
      .at(0)
    ...
    expect(
      wrapper
        ...
        .at(0)
        .text()
    ).toBe("This title is current close");
  });
  test("nested element has the correct open params pass to it", () => {
    const wrapper = mount(
      <Collapsible customTransition="height .1s ease-out" data={data2} />
    );
    wrapper
    ...
    expect(
      wrapper
        ...
        .at(2)
        .text()
    ).toBe("This nested title is current open");
    wrapper
      .find(CollapsePane)
      .find(Title)
      .at(1)
    ...
    expect(
      wrapper
        ...
        .at(2)
        .text()
    ).toBe("This nested title is current close");
  });
});
